...
// get products for product categories
...
// get products for related products from same category
...
//total price just without the RS 
function pay_price()
{
...
function customer_name(){
    ...
    // $get_c = "select * from customer where customer_email = '$c_id'";
    // $run_c = mysqli_query($db, $get_c);

    // while($run_c = mysqli_fetch_array($run_c)){
    //     $customer_name = $run_c['customer_name'];
    // }
    // echo $customer_name;
    ...
    // Query to retrieve customer name from database
    $sql = "SELECT customer_name FROM customer WHERE customer_email = '$customer_email'";
